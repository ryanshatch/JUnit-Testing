...
public class Contact {  // Class name
    ...
    public Contact(String contactId, String firstName, String lastName, String phone, String address) { // Constructor to create a contact object; with the paramaters as the first name, last name, phone number, and address.
        ...
        if (phone == null || phone.length() != 10 || !phone.matches("\\d+")) {  // Validation; if the phone number is null, the length is not equal to 10, or the phone number does not match the regular expression, then an exception is thrown.
